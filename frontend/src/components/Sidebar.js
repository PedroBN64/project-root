...
const Dashboard = () => {
  ...
  const toggleMenu = (menu) => {
    // Fechar todos os submenus quando um novo for aberto
    setExpandedMenus((prevState) => {
      const newExpandedMenus = {};
      // Se já estiver aberto, fechamos o menu
      if (prevState[menu]) {
        newExpandedMenus[menu] = false;
      } else {
        // Caso contrário, fechamos todos os outros menus e abrimos o menu clicado
